...
generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 9.0                        ! dark confinement scale",
            "HiddenValley:pTminFSR = 9.9                      ! pT cut off on dark shower (IR regulator)",
            "HiddenValley:spinFv=0                            ! spin of bifundamentals, which are not used, but set for consistency",
            "HiddenValley:probVector=0.75",
            "4900101:m0 = 3.6                                ! Dark Quark Mass, pythia 8 crashes if this is < 0.4 GeV",
            "4900111:m0 = 9.0                                ! Setting pi'0  Mass",
            "4900113:m0 = 9                                ! Setting omega'0 Mass",
            "4900113:addChannel = 1 0.051 91 1 -1                 ! pi0' -> d dbar",
            "4900113:addChannel = 1 0.205 91 2 -2                 ! pi0' -> u ubar",
            "4900113:addChannel = 1 0.051 91 3 -3                 ! pi0' -> s sbar",
            "4900113:addChannel = 1 0.205 91 4 -4                 ! pi0' -> c cbar",
            "4900113:addChannel = 1 0.027 91 5 -5                 ! pi0' -> b bbar",
            "4900113:addChannel = 1 0.154 91 11 -11                 ! pi0' -> e+ e-",
            "4900113:addChannel = 1 0.154 91 13 -13                 ! pi0' -> mu+ mu-",
            "4900113:addChannel = 1 0.152 91 15 -15                 ! pi0' -> tau+ tau-",
