...
generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "999999:all = GeneralResonance void 1 0 0 4.9 0.001 0. 0. 0.        ! dark photon A'",
            "999999:addChannel = 1 0.054 91 1 -1              ! A' -> d dbar",
            "999999:addChannel = 1 0.216 91 2 -2              ! A' -> u ubar",
            "999999:addChannel = 1 0.054 91 3 -3              ! A' -> s sbar",
            "999999:addChannel = 1 0.211 91 4 -4              ! A' -> c cbar",
            "999999:addChannel = 1 0.162 91 11 -11              ! A' -> e+ e-",
            "999999:addChannel = 1 0.162 91 13 -13              ! A' -> mu+ mu-",
            "999999:addChannel = 1 0.141 91 15 -15              ! A' -> tau+ tau-",
            ...
            "4900111:tau0 = 0.00010999999999999999                            ! proper lifetime, in mm",
            "4900211:onMode = 0",
        ),
