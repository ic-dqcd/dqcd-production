...
generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 11.5                        ! dark confinement scale",
            "HiddenValley:pTminFSR = 12.65                      ! pT cut off on dark shower (IR regulator)",
            "HiddenValley:spinFv=0                            ! spin of bifundamentals, which are not used, but set for consistency",
            "HiddenValley:probVector=0.75",
            "4900101:m0 = 4.6000000000000005                                ! Dark Quark Mass, pythia 8 crashes if this is < 0.4 GeV",
            "4900111:m0 = 11.5                                ! Setting pi'0  Mass",
            "4900113:m0 = 11.5                                ! Setting omega'0 Mass",
            ...
            "4900113:addChannel = 1 0.044 91 5 -5                 ! pi0' -> b bbar",
