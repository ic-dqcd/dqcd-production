...
generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 15.0                        ! dark confinement scale",
            "HiddenValley:pTminFSR = 16.5                      ! pT cut off on dark shower (IR regulator)",
            "HiddenValley:spinFv=0                            ! spin of bifundamentals, which are not used, but set for consistency",
            "HiddenValley:probVector=0.75",
            "4900101:m0 = 6.0                                ! Dark Quark Mass, pythia 8 crashes if this is < 0.4 GeV",
            "4900111:m0 = 15.0                                ! Setting pi'0  Mass",
            "4900113:m0 = 15.0                                ! Setting omega'0 Mass",
            ...
            "4900113:addChannel = 1 0.048 91 5 -5                 ! pi0' -> b bbar",
