...
generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 0.4                        ! dark confinement scale",
            "HiddenValley:pTminFSR = 0.44000000000000006                      ! pT cut off on dark shower (IR regulator)",
            ...
            "4900111:m0 = 0.4                                ! Setting pi'0  Mass",
            "4900113:m0 = 0.4                                ! Setting omega'0 Mass",
            "4900113:addChannel = 1 0.451 91 11 -11                 ! pi0' -> e+ e-",
            "4900113:addChannel = 1 0.436 91 13 -13                 ! pi0' -> mu+ mu-",
            "4900113:addChannel = 1 0.105 91 211 -211                 ! pi0' -> pi+ pi-",
