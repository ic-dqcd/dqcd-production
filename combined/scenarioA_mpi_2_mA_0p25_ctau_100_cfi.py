...
generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "999999:all = GeneralResonance void 1 0 0 0.25 0.001 0. 0. 0.        ! dark photon A'",
            "999999:addChannel = 1 0.562 91 11 -11              ! A' -> e+ e-",
            "999999:addChannel = 1 0.413 91 13 -13              ! A' -> mu+ mu-",
            "999999:tau0 = 100.0                            ! proper lifetime, in mm",
