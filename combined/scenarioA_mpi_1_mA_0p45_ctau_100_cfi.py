...
generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "999999:all = GeneralResonance void 1 0 0 0.45 0.001 0. 0. 0.        ! dark photon A'",
            "999999:addChannel = 1 0.424 91 11 -11              ! A' -> e+ e-",
            "999999:addChannel = 1 0.416 91 13 -13              ! A' -> mu+ mu-",
            "999999:addChannel = 1 0.138 91 211 -211              ! A' -> pi+ pi-",
            "999999:addChannel = 1 0.0169 91 211 -211 111              ! A' -> pi+ pi- pi0",
