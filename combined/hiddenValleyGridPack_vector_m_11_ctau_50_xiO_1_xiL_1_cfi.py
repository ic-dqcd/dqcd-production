...
generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 11.0                        ! dark confinement scale",
            "HiddenValley:pTminFSR = 12.100000000000001                      ! pT cut off on dark shower (IR regulator)",
            "HiddenValley:spinFv=0                            ! spin of bifundamentals, which are not used, but set for consistency",
            "HiddenValley:probVector=0.75",
            "4900101:m0 = 4.4                                ! Dark Quark Mass, pythia 8 crashes if this is < 0.4 GeV",
            "4900111:m0 = 11.0                                ! Setting pi'0  Mass",
            "4900113:m0 = 11                                ! Setting omega'0 Mass",
            "4900113:addChannel = 1 0.05 91 1 -1                 ! pi0' -> d dbar",
            "4900113:addChannel = 1 0.202 91 2 -2                 ! pi0' -> u ubar",
            "4900113:addChannel = 1 0.05 91 3 -3                 ! pi0' -> s sbar",
            "4900113:addChannel = 1 0.202 91 4 -4                 ! pi0' -> c cbar",
            "4900113:addChannel = 1 0.042 91 5 -5                 ! pi0' -> b bbar",
