...
generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 0.7                        ! dark confinement scale",
            "HiddenValley:pTminFSR = 0.77                      ! pT cut off on dark shower (IR regulator)",
            ...
            "4900111:m0 = 0.7                                ! Setting pi'0  Mass",
            "4900113:m0 = 0.7                                ! Setting omega'0 Mass",
            "4900113:addChannel = 1 0.144 91 11 -11                 ! pi0' -> e+ e-",
            "4900113:addChannel = 1 0.144 91 13 -13                 ! pi0' -> mu+ mu-",
            "4900113:addChannel = 1 0.704 91 211 -211                 ! pi0' -> pi+ pi-",
            "4900113:addChannel = 1 0.005 91 211 -211 111                 ! pi0' -> pi+ pi- pi0",
