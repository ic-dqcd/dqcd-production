...
# with command line options: --python_filename miniaod_postBPix_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:output_miniaod.root --conditions 130X_mcRun3_2023_realistic_postBPix_v6 --step PAT --geometry DB:Extended --filein file:input.root --era Run3_2023 --no_exec --mc -n -1 --customise_commands process.source.bypassVersionCheck=cms.untracked.bool(True)
