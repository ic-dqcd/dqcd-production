...
# with command line options: --python_filename gensim_postBPix_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:output.root --filein /scenarioA_mpi_10_mA_1p00_ctau_0p1/tafoyava-scenarioA_mpi_10_mA_1p00_ctau_0p1_2023-622dffdc6a3cfe7c99a725908eb67d1a/USER --conditions 130X_mcRun3_2023_realistic_postBPix_v6 --beamspot Realistic25ns13p6TeVEarly2023Collision --step SIM --geometry DB:Extended --era Run3_2023 --no_exec --mc -n 10 --customise_commands process.source.bypassVersionCheck=cms.untracked.bool(True)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/scenarioA_mpi_10_mA_1p00_ctau_0p1/tafoyava-scenarioA_mpi_10_mA_1p00_ctau_0p1_2023-622dffdc6a3cfe7c99a725908eb67d1a/USER'),
