...
# with command line options: --python_filename aod_cfg.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:aod.root --conditions 130X_mcRun3_2023_realistic_v15 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:input.root --era Run3_2023 --no_exec --mc -n 10 --customise_commands process.source.bypassVersionCheck=cms.untracked.bool(True)
